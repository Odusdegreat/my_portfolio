...
const Navbar = () => {
    ...
    return (
        <section className='flex flex-col gap-4 sticky top-16'>
            ...
            {path === '' &&
                <div className='px-3 py-2 border-[1px] border-accent rounded-full'>
                    <a href='https://docs.google.com/document/d/1exbVtHR29vz7ALWcVdRg4xx_qeFrnw60fgA_pReKmmE/preview' target="_blank" rel="noreferrer" className='icon' data-title='Resume'>
                        <lord-icon
